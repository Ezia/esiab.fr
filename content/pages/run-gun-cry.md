...
*Run, Gun, Cry!* est actuellement en cours de développement. À ce jour, la phase de conception et de plannification est terminée et le projet entre dans sa première semaine de sprint.
...
<div class="row align-items-center">
    ...
    <div class="col-12 col-lg-6 py-4">
        La simulation se présente sous la forme d'un cylindre composé de <strong>plateformes</strong> sur lesquelles le mecha peu se déplacer. Pour géner sa progression, des <strong>ennemis</strong> et des <strong>obstacles</strong> sont aussi disséminés dans le niveau.
    </div>
</div>
...
* **L'artilleur** contrôlle le viseur à la **souris** et a pour objectif de tirer sur les ennemis et les obstacles pour protéger le mecha.

* **L'ingénieur** a pour mission de maintenir le niveau d'énergie du mecha suffisamment haut pour permettre à ses co-pilotes d'effectuer leurs actions. Il doit tapper des lettres sur le **clavier** pour remonter l'énergie.
...
<div class="row">    
    ...
    <div class="col-12 col-lg-3 py-4">
        <img style="width: 100%;" src="/images/lovers_in_a_dangerous_spacetime.png" alt="Lovers in a Dangerous Spacetime">
...
* Animer une réunion, un braistorming
...
* Faire de bonnes user stories (INVERT)
* Réaliser un backlog produit complet
* Evaluer aussi justement que possible l'effort et la priorité de chaque tâche
